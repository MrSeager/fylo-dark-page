...
const SectionThree: FC<SectionThreeProps> = ({ head, par_1, par_2 }) => {
    return (
        <Container fluid className='cs-bg-darkblue-second p-5'>
            <Row className='px-lg-5 px-0 gap-lg-0 gap-5 '>
                <Col data-aos="fade-right" lg={6} xs={12}>
                    <Image fluid src={ImgSP} alt='stay productive' className='pe-lg-4 pe-0' /> 
                </Col>
                <Col data-aos="fade-left" lg={6} xs={12} className='gap-2 ps-lg-4 ps-0 text-white d-flex flex-column justify-content-center align-items-start'>
