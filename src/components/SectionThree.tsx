    ...
    return (
        <Container fluid className='cs-bg-darkblue-second px-5 py-5'>
            <Row className='px-lg-5 px-0 gap-lg-0 gap-5'>
                <Col lg={6} xs={12}>
                    <Image fluid src={ImgSP} alt='stay productive' className='pe-4' /> 
                </Col>
                <Col lg={6} xs={12} className='gap-2 ps-4 text-white d-flex flex-column justify-content-center align-items-start'>
